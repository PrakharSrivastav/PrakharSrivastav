...
<div class="row">
    <div class="col-lg-12 border-top-colored">
        <div class="h2 bg-colored text-black text-center col-sm-12 col-lg-12 col-md-12 col-xs-12 padding-5">
            My Recent Works
        </div>
        ...
        <div class="col-sm-6 col-lg-4 col-md-4 col-xs-12">
            <div class="panel">
                ...
                <ul style="padding-left:15px;font-size:12px" class="padding-5">
                    <li>
                        Built on Twitter-Bootstrap (HTML/CSS/Javascript/JQuery).
                    </li>
                    <li>
                        PHP-Mysql (CodeIgniter Framework).
                    </li>
                    <li>
                        Twitter - API integrations for capturing Twitter feeds.
                    </li>
                    <li>
        ...
        <!--end col-sm-6 col-lg-4 col-md-4 col-xs-12-->
        ...
        </div><!--end col-sm-6 col-lg-4 col-md-4 col-xs-12-->
        <div class="col-sm-6 col-lg-4 col-md-4 col-xs-12">
            <div class="panel">
...
<div class="row">
    <h4 class="text-black text-center bold">If you have a requirement similar to any of the projects above, I would be looking forward to do it for you. </h4>
    <p class="help-text text-center bold">
