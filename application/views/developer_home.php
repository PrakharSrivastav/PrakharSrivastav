<?php $this->load->view("templates/header-home"); ?>
...
<section class="home-page-intro border-top-white  col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="work-intro text-center">
		I work on<br />
		HTML5 / Javascript / PHP / Mysql / Java / Bootstrap / Spring / JQuery / Ajax / JEE / EJB / CSS<br />
...
<?php $this->load->view("templates/footer-home"); ?>